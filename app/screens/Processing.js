      ...
      <Shell>
        <div style={{ flex: 1, display: "grid", placeItems: "center", padding: 30 }}>
          <div style={{ textAlign: "center" }}>
            ...
            <div className="disp" style={{ fontSize: 20, fontWeight: 600, marginTop: 12 }}>{sourceMode === "topic" ? "Thinking it through…" : "Reading your work…"}</div>
