...
This project isn't connected to a git repository yet, it's deployed as files
directly. Reconnecting it to a GitHub repo would give you deploy-on-push instead.
